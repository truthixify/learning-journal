...
- We can also add more data, there are ways to do this like data augmentation(good for image and audio) like generating new data by modifying training examples and we can use data synthesis to generate completely new data from artific
- ---
- ## Connection
