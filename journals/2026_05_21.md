...
- We can also use the techniques of transfer learning when we have a small dataset, we can train on a related large dataset first(supervised pretraining) then fine-tune on
- ---
- ## Connection
