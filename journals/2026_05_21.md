...
- Another way to inspect and visualize the model is to plot the training and validation error as a function of the training set size, we can inspect how well the model does by adding more data. Note that
- ---
- ## Connection
