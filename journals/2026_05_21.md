...
- We can see from the equations above that high training error leads to high bias and low training error and high validation error leads to overfitting whil
-
-
- ---
- ## Connection
