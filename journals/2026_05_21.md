...
- How to fix high variance(overfitting):
	...
	- Use a simpler model
- We mostly have the issue of high bias for classical ML, neural networks fixes this problem coz they learn as much as possible and for the high variance problem, we can add more training data and regularization to
-
- ---
- ## Connection
