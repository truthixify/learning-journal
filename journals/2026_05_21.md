...
- We can do this in two ways where the first is to fine tune the whole network and the second is to train only the new output layer's weights(when we have
- ---
- ## Connection
