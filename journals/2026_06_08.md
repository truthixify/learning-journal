...
- When we have continuous spaces like we do have in real life, we will use a neural network to compute or approximate the state-value function $Q(s,a)$ and that will in turn
- ---
- ## Connection
