...
- The choice of activation function from the output depends on the type of problem we are trying to solve, for binary classification -> sigmoid, multi class classifi
- ---
- ## Connection
