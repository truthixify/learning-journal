...
- So why ReLU? The first is that it is faster to compute compared to sigmoid, doesn't saturate on the positive side and thus no vanishing gradient like sigmoid and in practice, neural network with ReLU hidden layer
- ---
- ## Connection
