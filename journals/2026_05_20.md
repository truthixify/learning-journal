...
- Backprop has a closed form which i computed but we cannot always recompute everytime we need it, this takes me back to the Mathematics for ML course where we used cache to keep some derivatives so we can reuse them for implementing our multilayer n
- ---
- ## Bugs & Blockers
- N/A
- ---
