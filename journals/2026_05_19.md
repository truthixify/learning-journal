...
- Input layer which receives the raw input features, hidden layers which are intermediate computational values learned from the network and the output layer which is the final layer that produces the preditiction.
...
- Even though Andrew never went into detail about back propagation maybe because talking about the derivation and intuition will take a while, I have actually done a pretty complex backprop for a multiplayer network where the activation function is the sigmoid function
- ---
- ## Bugs & Blockers
- N/A
- ---
