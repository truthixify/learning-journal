...
- ---
- ## Connection
- The striking connection is what I'm just building a recommendation algorithm from a side gig I got, I had planned to use retrieval by using embeddings between the user and the item plus some other methods like keyword search too and then passing the list(about 50) to an LLM to make the final judgement and recommend about 10 user
- ---
- ## Bugs & Blockers
- N/A
- ---
