...
- The loss $L$ can be mean squared error for linear regression problem or binary cross-entropy for logistic regression problem, which means we can use the logi
- ---
- ## Connection
- N/A
- ---
