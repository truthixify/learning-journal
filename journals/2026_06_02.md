...
- Limitations of collaborative filtering is the cold start problem(how do we rank new items that few users have rated and how do we show something reasonable to new users who have r) and how do we use information(item: genres, stars,... user: demographics, preferences,...)
- ---
- ## Connection
- N/A
- ---
